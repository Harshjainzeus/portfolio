...
```html
<link rel="icon" type="image/svg+xml" href="/images/svg/logo.png" />
...
The logo shown in the **preloader** is a static svg file located at `public/images/svg/logo.png`. If you're customizing your theme's color scheme, it's a good idea to use a logo that visually matches your new colors for better consistency and aesthetics. 
